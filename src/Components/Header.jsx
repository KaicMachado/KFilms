const Header = () => {
 return (
  <div className="bg-[url('./assets/bg.jpg')] bg-center  bg-no-repeat ">
   <div className="h-52 md:h-72 w-max-full text-white mx-auto grid grid-cols-1 sm:grid-cols-[60%_40%] font-serif items-center">
